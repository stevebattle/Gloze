...
java -cp $CP -Dgloze.target=. -Dgloze.verbose=true -Dgloze.xmlns=http://example.org -Dgloze.base=http://example.org/empty -Dgloze.roundtrip=true com.hp.gloze.Gloze empty.xml empty.xsd 
