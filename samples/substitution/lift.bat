...
java -cp %CP% -Dgloze.target=. -Dgloze.verbose=true -Dgloze.roundtrip=true -Dgloze.base=http://example.org/ipo com.hp.gloze.Gloze substitution.xml http://www.example.com/IPO ipo.xsd 
