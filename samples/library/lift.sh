...
java -cp $CP -Dgloze.verbose=true -Dgloze.xmlns=http://example.org/library/schema -Dgloze.base=http://example.org/library com.hp.gloze.Gloze library.xml library.xsd 
