...
java -cp $CP -Dgloze.target=. -Dgloze.verbose=true -Dgloze.base=http://example.org/po -Dgloze.roundtrip=true com.hp.gloze.Gloze po.xml http://tempuri.org/po.xsd po.xsd
