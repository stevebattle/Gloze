...
java -cp %CP% com.hp.gloze.GlozeURL http://www.agencexml.com/xsltforms/address.xml http://www.w3.org/2002/xforms http://www.w3.org/MarkUp/Forms/2007/XForms-11-Schema.xsd