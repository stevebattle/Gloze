...
java -cp %CP% -Dgloze.order=seq -Dgloze.target=. -Dgloze.verbose=true -Dgloze.base=http://example.org/4Q99.xml -Dgloze.roundtrip=true com.hp.gloze.Gloze 4Q99.xml http://www.example.com/IPO ipo.xsd http://www.example.com/Report report.xsd
