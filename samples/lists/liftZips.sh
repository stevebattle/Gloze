...
java -cp $CP -Dgloze.target=. -Dgloze.verbose=true -Dgloze.xmlns=http://example.org -Dgloze.base=http://example.org/zips -Dgloze.roundtrip=true -Dgloze.lang=N3 com.hp.gloze.Gloze zips.xml lists.xsd 
