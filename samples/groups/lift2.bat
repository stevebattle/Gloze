...
java -cp %CP% -Dgloze.target=. -Dgloze.verbose=true -Dgloze.base=http://example.org/po1 -Dgloze.lang=N3 -Dgloze.roundtrip=true com.hp.gloze.Gloze po1.xml http://www.example.com/PO1 po2.xsd
