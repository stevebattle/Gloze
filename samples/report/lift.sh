...
java -cp $CP -Dgloze.target=. -Dgloze.verbose=true -Dgloze.base=http://example.org/4Q99 com.hp.gloze.Gloze 4Q99.xml http://www.example.com/IPO ipo.xsd http://www.example.com/Report report.xsd 
