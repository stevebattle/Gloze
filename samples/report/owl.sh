...
java -cp $CP -Dgloze.verbose=true -Dgloze.target=. -Dgloze.base=http://example.org/report -Dgloze.lang=N3 com.hp.gloze.Gloze report.xsd http://www.example.com/IPO ipo.xsd 
