...
java -cp %CP% -Dgloze.target=. -Dgloze.verbose=true -Dgloze.lang=N3 -Dgloze.xmlns=http://example.org -Dgloze.base=http://example.org/nil -Dgloze.roundtrip=true com.hp.gloze.Gloze nil.xml nil.xsd
